...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "jenkins01" do |h|
    h.vm.provider :virtualbox do |virtualbox|
      virtualbox.customize ["modifyvm", :id, "--memory", "4096"]
    end

    h.vm.host_name = "jenkins01"
    h.vm.network "private_network", ip: "192.168.135.101"
    h.vm.network "forwarded_port", guest: "8080", host: "8081", host_ip: "127.0.0.1"
  ...
  config.vm.define "sonar01" do |h|
    ...
    h.vm.network "forwarded_port", guest: "9000", host: "9001", host_ip: "127.0.0.1"
